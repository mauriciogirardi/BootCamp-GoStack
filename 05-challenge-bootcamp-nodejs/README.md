...
Nesse desafio, Nós tivemos que criar uma aplicação para continuar treinando o que aprendemos até agora no Node.js junto ao TypeScript, utilizando o conceito de models, repositories e services!
